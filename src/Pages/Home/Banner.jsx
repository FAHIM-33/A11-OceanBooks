...
{/* 
            ...
            <div className='absolute top-0 md:w-1/2 z-10 flex items-center text-white bottom-0'>
            ...
            <div className='absolute z-20 w-full flex items-center justify-center bg-fadegray bottom-0 gap-4 p-2'>
